...
otu <-read.table(file="phylum.xls",header=T,check.names=FALSE,sep="\t")
rownames(otu) <- otu[,1]
...
#	tiff(paste("pie.",smp,".phylum.xls.tiff",sep=""),width=10,height=5,pointsize=15)
	#pdf(paste("pie.",smp,".phylum.xls.pdf",sep=""),width=10,height=5)
